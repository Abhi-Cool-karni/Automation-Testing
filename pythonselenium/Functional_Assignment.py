...
for product in products:
    ActualProductName.append(product.find_element(By.XPATH, "h4").text)
    product.find_element(By.XPATH, "div/button").click()

assert expected == ActualProductName
# print("Expected list and Actual list matches =", ActualProductName)
